...
class Memory(object):
    ...
    def sample(self, batch_size):
        ...
        batch_images, batch_vectors, batch_actions, batch_rewards, batch_next_images, batch_next_vectors, batch_dones = map(np.array, zip(*samples))
        return batch_images, batch_vectors, batch_actions, batch_rewards, batch_next_images, batch_next_vectors, batch_dones
